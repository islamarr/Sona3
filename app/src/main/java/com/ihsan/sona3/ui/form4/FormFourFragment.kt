...
package com.ihsan.sona3.ui.form4
...
class FormFourFragment() : BaseFragment<FragmentFormFourBinding>() {

    override val bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> FragmentFormFourBinding
        get() = FragmentFormFourBinding::inflate
    ...
    override fun setupOnViewCreated(view: View) {
        ...
        binding.next.setOnClickListener {
            navController.navigate(R.id.action_formFourFragment_to_formFiveFragment)
             }
        binding.befor.setOnClickListener {
            navController.navigate(R.id.action_formFourFragment_to_formThreeFragment)
